...
class SongSelect(tk.Frame):
	def __init__(self, parent, controller):
		...
		# bugs button
		bugs = tk.Button(self, text="bugs", width="15", highlightthickness="0", command=lambda: controller.show_color_menu(".\\audio\\bugs_left_turn.wav"))
		bugs.config(font=BUTTON_FONT)

		# song1 button
		song1 = tk.Button(self, text="Hands Down", width="15", highlightthickness="0", command=lambda: controller.show_color_menu(".\\audio\\bugs_left_turn.wav"))
		song1.config(font=BUTTON_FONT)

		# song2 button
		song2 = tk.Button(self, text="Return of the Mack", width="15", highlightthickness="0", command=lambda: controller.show_color_menu(".\\audio\\return_of_the_mack.wav"))
		song2.config(font=BUTTON_FONT)

		# song3 button
		song3 = tk.Button(self, text="Going to California", width="15", highlightthickness="0", command=lambda: controller.show_color_menu(".\\audio\\going_to_california.wav"))
...
class ColorSelect(tk.Frame):
	def __init__(self, parent, controller):
		...
		# cyan
		cyan = tk.Button(self, text="cyan", width="15", fg="#00ffff", highlightthickness="0", command=lambda: controller.show_style_menu('cyan'))
		cyan.config(font=BUTTON_FONT)

		# magenta
		magenta = tk.Button(self, text="magenta", width="15", fg="#ff00ff", highlightthickness="0", command=lambda: controller.show_style_menu('magenta'))
		magenta.config(font=BUTTON_FONT)

		# green
		green = tk.Button(self, text="green", width="15", fg="#00FF00", highlightthickness="0", command=lambda: controller.show_style_menu('green'))
		green.config(font=BUTTON_FONT)

		# black
		black = tk.Button(self, text="black", width="15", highlightthickness="0", command=lambda: controller.show_style_menu('black'))
...
class StyleSelect(tk.Frame):
	def __init__(self, parent, controller):
		...
		# solid line
		solid_line = tk.Button(self, text="[][][][][][][][]", width="15", highlightthickness="0", command=lambda: controller.show_visual_menu('square'))
		solid_line.config(font=BUTTON_FONT)

		# circle
		circle = tk.Button(self, text="ooooooooooooooo", width="15", highlightthickness="0", command=lambda: controller.show_visual_menu('circle'))
		circle.config(font=BUTTON_FONT)

		# star
		star = tk.Button(self, text="********************", width="15", highlightthickness="0", command=lambda: controller.show_visual_menu('asterisk'))
		star.config(font=BUTTON_FONT)


		# pixel
		pixel = tk.Button(self, text="++++++++++++++++++++", width="15", highlightthickness="0", command=lambda: controller.show_visual_menu('cross'))
